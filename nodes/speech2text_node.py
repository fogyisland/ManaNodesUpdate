...
class speech2text:
    ...
    # Main                                                                #
    # ------------------------------------------------------------------ #
    def run(self, audio_file, asr_model: str,
        ...
        # Whisper auto-detects the language. We deliberately don't
        # expose a `language` parameter: previous versions did and
        # users kept filling the placeholder / field name into it,
        # causing 'Unsupported language: language' errors. Auto is
        # accurate enough for our use cases.
        words = self._transcribe(audio, asr_model)
    ...
    # Transcribe (Whisper)                                                #
    # ------------------------------------------------------------------ #
    def _transcribe(self, audio_array, model_size: str):
        ...
        logger().info(
            ...
            "rms=%.4f, model=%s, language=auto",
            len(audio_array), duration_s, peak, rms, model_size,
        )
